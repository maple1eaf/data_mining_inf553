...
if system_type == 'Linux':
    ...
    user_json = "../resource/asnlib/publicdata/user.json"
    business_json = "../resource/asnlib/publicdata/business.json"
    ...
    print(system_type)
    # run for local macos
    stopwords_file = "file:///Users/markduan/duan/USC_course/USC_APDS/INF553/project/deliver/stopwords"
    ...
    model_dir = './model/'
    als_model_file = model_dir + "als.json"
    checkpoint_file = "file:///Users/markduan/duan/USC_course/USC_APDS/INF553/project/deliver/checkpoint"
    agm_train_file = model_dir + "agm_train.json"
else:
